...
def preprocess_data(data,standard_scaler_path,min_max_scaler_path):
    '''
    ...
    print(f"Scalers saved to {standard_scaler_path} and {min_max_scaler_path}")

    print("Data preprocessing and feature engineering completed")

    return data

def load_and_preprocess(file_path,standard_scaler_path,min_max_scaler_path):
    '''
    Loads and preprocesses the data
    '''

    data = load_data(file_path)
    processed_data = preprocess_data(data,standard_scaler_path,min_max_scaler_path)
...
if __name__=='__main__':
    ...
    standard_scaler_path = "../../data/models/standard_scaler.pkl"
    min_max_scaler_path = "../../data/models/min_max_scaler.pkl"

    processed_data = load_and_preprocess(input_path,standard_scaler_path,min_max_scaler_path)
